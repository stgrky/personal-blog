...
const MentalHealth: NextPage<MentalHealthProps> = ({ devPortfolioContent }) => {
  ...
  return (
    <div className="container mx-auto rounded-lg px-10 mb-8 bg-gray-50">
      <Head>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 text-gray-800">
        <div className="lg:col-span-4 col-span-1">
          <h1 className="md:mb-8 md:mt-8 text-4xl md:text-6xl font-extrabold text-gray-700">
            Mental Health
          </h1>
          <div className="flex items-center space-x-2 mt-4">
            ...
            <div className="float-right">
              <button className="inline-block bg-blue-400 text-white font-bold py-2 px-4 rounded">
...
export async function getStaticProps() {
  const mentalHealth = (await getMentalHealthPageDetails()) || [];
